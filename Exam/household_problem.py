...
@nb.njit       
def solve_hh_backwards(par,z_trans,ra,Z,Delta,delta,vbeg_a_plus,vbeg_a,a,c,y,aux,ss=False):
    ...
    for i_fix in range(par.Nfix):
        ...
        for i_z in range(par.Nz):
            ...
            # z
            z = par.e_grid[i_z]**(1-par.theta)/par.e_scale*Delta
            if par.u_grid[i_z]:
                z *= par.phi_ubar
            else:
                z *= par.phi_obar
